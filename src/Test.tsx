import { Button, Card as MCard, IconButton } from '@material-tailwind/react'
import React, { FC, Fragment, useEffect, useState } from 'react'
import LetterInput from './LetterInput'
import { ITestCard } from './store/testReducer'
...
const Test: FC = () => {
  ...
  const testNumber = useAppSelector((state) => state.test.number)
  ...
  let cards: ITestCard = useAppSelector((state) => state.test)
  ...
  return (
    <MCard className="mx-16 my-7 shadow-2xl shadow-green-500 flex flex-col px-5 bg-gray-200">
